 ...
 * Modified for ErrorHook
 * Based on http://github.com/swt83/laravel-smtp
 *
 * @package    Debug\ErrorHook;
 * @license    MIT License
 */
...
class Smtp
{
    ...
    public function __construct($options)
    {
        ...
        // set debug mode
        $this->debug_mode = !empty($options['debug_mode']);
    }
